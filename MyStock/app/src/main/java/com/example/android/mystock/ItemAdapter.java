...
public class ItemAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        ImageView ivImage = (ImageView) view.findViewById(R.id.list_item_image);
        TextView tvQuantity = (TextView) view.findViewById(R.id.list_item_quantity);
        TextView tvPrice = (TextView) view.findViewById(R.id.list_item_price);
